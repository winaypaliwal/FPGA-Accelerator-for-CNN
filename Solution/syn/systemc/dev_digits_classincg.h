...
#ifndef __dev_digits_classincg__HH__
#define __dev_digits_classincg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dev_digits_classincg) {
    ...
    SC_CTOR(dev_digits_classincg):  ACMP_uitofp_U ("ACMP_uitofp_U") {
