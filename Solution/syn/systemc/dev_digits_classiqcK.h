...
#ifndef __dev_digits_classiqcK__HH__
#define __dev_digits_classiqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dev_digits_classiqcK) {
    ...
    SC_CTOR(dev_digits_classiqcK):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
