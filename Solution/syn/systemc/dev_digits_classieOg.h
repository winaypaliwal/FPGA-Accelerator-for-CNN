...
#ifndef __dev_digits_classieOg__HH__
#define __dev_digits_classieOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dev_digits_classieOg) {
    ...
    SC_CTOR(dev_digits_classieOg):  simcore_mac_0_U ("simcore_mac_0_U") {
