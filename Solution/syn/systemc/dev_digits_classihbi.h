...
#ifndef __dev_digits_classihbi__HH__
#define __dev_digits_classihbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dev_digits_classihbi) {
    ...
    SC_CTOR(dev_digits_classihbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
